...
<body>
	...
	<%
		...
		String mp3 = "";
		String realFolder = "C:\\Users\\MWS\\eclipse-workspace\\musicpro\\WebContent\\mp3file"; //웹 어플리케이션상의 절대 경로
	...
	<sql:setDataSource var="dataSource"
		...
		driver = "com.mysql.jdbc.Driver" user="root" password="java0000" />
		<sql:update dataSource="${dataSource}" var="resultSet">
		UPDATE INTO music(musicname, mp3, singer) VALUES (?,?,?)
